...
<div class="row">
    ...
    <div class="col-md-2 col-sm-6 col-xs-12">
        <div class="info-box">
            <div class="info-box-content p-md">
                <span class="info-box-number"><i class="icon ion-bag purple"></i> <?= $productSellCount + $productWarehouseCount ?></span>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue pointer openContab" data-title="待付款" href="<?= Url::to(['order/order/index', 'order_status' => OrderStatusEnum::NOT_PAY])?>"><?= $orderTotalList[OrderStatusEnum::NOT_PAY] ?? 0; ?></span>
                        <div class="knob-label">待付款</div>
                    </div>
                    <!-- ./col -->
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue pointer openContab" data-title="待发货" href="<?= Url::to(['order/order/index', 'order_status' => OrderStatusEnum::PAY])?>"><?= $orderTotalList[OrderStatusEnum::PAY] ?? 0; ?></span>
                        <div class="knob-label">待发货</div>
                    </div>
                    <!-- ./col -->
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue pointer openContab" data-title="已发货" href="<?= Url::to(['order/order/index', 'order_status' => OrderStatusEnum::SHIPMENTS])?>"><?= $orderTotalList[OrderStatusEnum::SHIPMENTS] ?? 0; ?></span>
                        <div class="knob-label">已发货</div>
                    </div>
                    <!-- ./col -->
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue pointer openContab" data-title="已收货" href="<?= Url::to(['order/order/index', 'order_status' => OrderStatusEnum::SING])?>"><?= $orderTotalList[OrderStatusEnum::SING] ?? 0; ?></span>
                        <div class="knob-label">已收货</div>
                    </div>
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue pointer openContab" data-title="已关闭" href="<?= Url::to(['order/order/index', 'order_status' => OrderStatusEnum::REPEAL])?>"><?= $orderTotalList[OrderStatusEnum::REPEAL] ?? 0; ?></span>
                        <div class="knob-label">已关闭</div>
                    </div>
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue pointer openContab" data-title="售后申请" href="<?= Url::to(['order/order/index', 'order_status' => OrderStatusEnum::REFUND_APPLY])?>"><?= $orderTotalList[OrderStatusEnum::REFUND_APPLY] ?? 0; ?></span>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xs-6 col-md-4 text-center">
                        <span class="info-box-number blue"><?= $productSellCount ?></span>
                        <div class="knob-label">出售中</div>
                    </div>
                    <div class="col-xs-6 col-md-4 text-center">
                        <span class="info-box-number blue"><?= $productWarehouseCount ?></span>

 ...
 * @property int $promotion_type_id 促销类型
...
class OrderProduct extends BaseModel
{
    ...
    {
        return [
            [['member_id', 'order_id', 'merchant_id', 'product_id', 'sku_id', 'is_virtual', 'num', 'buyer_id', 'point_exchange_type', 'promotion_id', 'promotion_type_id', 'order_type', 'order_status', 'give_point', 'shipping_status', 'refund_type', 'refund_status', 'is_evaluate', 'refund_time', 'tmp_express_company_id', 'gift_flag', 'status', 'created_at', 'updated_at'], 'integer'],

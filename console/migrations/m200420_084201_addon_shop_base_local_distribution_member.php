...
class m200420_084201_addon_shop_base_local_distribution_member extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_shop_base_local_distribution_member}}', [
            ...
            'remark' => "text NULL COMMENT '配送人员备注'",
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_shop_base_local_distribution_member}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

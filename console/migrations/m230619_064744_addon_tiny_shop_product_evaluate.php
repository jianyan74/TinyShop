...
class m230619_064744_addon_tiny_shop_product_evaluate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_tiny_shop_product_evaluate}}', [
            ...
            'is_anonymous' => "tinyint(4) NULL DEFAULT '0' COMMENT '0表示不是 1表示是匿名评价'",
            'scores' => "tinyint(4) NOT NULL COMMENT '1-5分'",
            ...
            'has_again' => "tinyint(4) unsigned NULL DEFAULT '0' COMMENT '是否追加 0 否 1 是'",
            'has_content' => "tinyint(1) unsigned NULL DEFAULT '0' COMMENT '是否有内容 0 否 1 是'",
            'has_cover' => "tinyint(4) unsigned NULL DEFAULT '0' COMMENT '是否有图 0 否 1 是'",
            'has_video' => "tinyint(4) unsigned NULL DEFAULT '0' COMMENT '是否视频 0 否 1 是'",
            'is_auto' => "tinyint(4) unsigned NULL DEFAULT '0' COMMENT '是否自动评价 0 否 1 是'",
        ...
        /* 索引设置 */
        $this->createIndex('product_id','{{%addon_tiny_shop_product_evaluate}}','product_id',0);
        $this->createIndex('merchant_id','{{%addon_tiny_shop_product_evaluate}}','merchant_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_shop_product_evaluate}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

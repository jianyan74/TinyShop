...
class m230619_064744_addon_tiny_shop_common_opinion extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%addon_tiny_shop_common_opinion}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='扩展_微商城_公共_意见反馈'");
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_shop_common_opinion}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

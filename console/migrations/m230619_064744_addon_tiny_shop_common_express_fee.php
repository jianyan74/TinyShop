...
class m230619_064744_addon_tiny_shop_common_express_fee extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_tiny_shop_common_express_fee}}', [
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_shop_common_express_fee}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

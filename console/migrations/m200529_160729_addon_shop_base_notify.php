...
class m200529_160729_addon_shop_base_notify extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_shop_base_notify}}', [
        ...
        /* 索引设置 */
        $this->createIndex('target_type','{{%addon_shop_base_notify}}','target_type',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_shop_base_notify}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

...
class m230619_064744_addon_tiny_shop_marketing_full_mail extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_tiny_shop_marketing_full_mail}}', [
        ...
        /* 索引设置 */
        $this->createIndex('merchant_id','{{%addon_tiny_shop_marketing_full_mail}}','merchant_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_shop_marketing_full_mail}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

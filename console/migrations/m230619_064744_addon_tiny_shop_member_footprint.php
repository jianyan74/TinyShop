...
class m230619_064744_addon_tiny_shop_member_footprint extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_tiny_shop_member_footprint}}', [
        ...
        /* 索引设置 */
        $this->createIndex('member_id','{{%addon_tiny_shop_member_footprint}}','member_id, product_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_shop_member_footprint}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

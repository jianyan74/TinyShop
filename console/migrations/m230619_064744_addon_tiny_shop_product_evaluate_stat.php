...
class m230619_064744_addon_tiny_shop_product_evaluate_stat extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%addon_tiny_shop_product_evaluate_stat}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='扩展_微商城_商品评价统计表'");
        
        /* 索引设置 */
        $this->createIndex('product_id','{{%addon_tiny_shop_product_evaluate_stat}}','product_id',0);
        $this->createIndex('merchant_id','{{%addon_tiny_shop_product_evaluate_stat}}','merchant_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%addon_tiny_shop_product_evaluate_stat}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}

...
class m191009_090109_addon_shop_order_product_express extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%addon_shop_order_product_express}}', [
            ...
            'manager_username' => "varchar(50) NULL COMMENT '用户名'",
            'memo' => "varchar(255) NULL DEFAULT '' COMMENT '备注'",
            'status' => "tinyint(4) NULL DEFAULT '1' COMMENT '状态[-1:删除;0:禁用;1启用]'",
            'created_at' => "int(10) NULL DEFAULT '0'",
            'updated_at' => "int(10) NULL DEFAULT '0'",
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AVG_ROW_LENGTH=606 ROW_FORMAT=DYNAMIC COMMENT='商品订单物流信息表（多次发货）'");
        
        /* 索引设置 */
        $this->createIndex('UK_ns_order_goods_express_order_id','{{%addon_shop_order_product_express}}','order_id',0);
        $this->createIndex('UK_ns_order_goods_express_uid','{{%addon_shop_order_product_express}}','member_id',0);

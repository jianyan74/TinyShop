            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue"><?= isset($orderTotalList[0]) ? $orderTotalList[0]['count'] : 0; ?></span>
                        <div class="knob-label">待付款</div>
                    </div>
                    <!-- ./col -->
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue"><?= isset($orderTotalList[1]) ? $orderTotalList[1]['count'] : 0; ?></span>
                        <div class="knob-label">待发货</div>
                    </div>
                    <!-- ./col -->
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue"><?= isset($orderTotalList[2]) ? $orderTotalList[2]['count'] : 0; ?></span>
                        <div class="knob-label">已发货</div>
                    </div>
                    <!-- ./col -->
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue"><?= isset($orderTotalList[3]) ? $orderTotalList[3]['count'] : 0; ?></span>
                        <div class="knob-label">已收货</div>
                    </div>
                    <div class="col-xs-6 col-md-2 text-center">
                        <span class="info-box-number blue"><?= isset($orderTotalList[-4]) ? $orderTotalList[-4]['count'] : 0; ?></span>
...
<div class="row shop-index">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="box box-solid">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xs-12 col-md-12 pull-right" style="padding-top: 31px;padding-bottom: 31px">
                        <table class="table">
                            <tbody>
                            <tr>
